...
(function() {
 ...
 <td style="padding:8px;border-bottom:1px solid rgba(255,255,255,0.08);text-align:center;color:${noindex?'#fb7185':'#9aa1b8'};font-weight:${noindex?'700':'400'};">${noindex?'Yes':'—'}</td>`;
